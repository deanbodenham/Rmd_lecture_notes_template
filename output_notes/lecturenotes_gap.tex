...
\mainmatter
\setboolean{showtext}{false}
\setboolean{useframe}{true}
\setboolean{gaptextisblue}{false}
...
\begin{center}\includegraphics{lecturenotes_gap_files/figure-latex/normpdf-1} \end{center}
...
{\centering \includegraphics{lecturenotes_gap_files/figure-latex/gammadataplot-1} 
...
{\centering \subfloat[A figure caption\label{fig:carsfigureandtable1}]{\includegraphics[width=.49\linewidth]{lecturenotes_gap_files/figure-latex/carsfigureandtable-1} }\subfloat[A table caption\label{fig:carsfigureandtable2}]{\includegraphics[width=.49\linewidth]{lecturenotes_gap_files/figure-latex/carsfigureandtable-2} }
